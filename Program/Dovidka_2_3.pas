...
var
  fmDovidka_2_3: TfmDovidka_2_3;

implementation

{$R *.DFM}

procedure TfmDovidka_2_3.FormCreate(Sender: TObject);
begin
...
procedure TfmDovidka_2_3.load_data;
begin
...
procedure TfmDovidka_2_3.button_showClick(Sender: TObject);
begin
...
procedure TfmDovidka_2_3.reportGetValue(const ParName: String;
...
function TfmDovidka_2_3.execute_query: boolean;
begin
   ...
   then begin
        ...
        fmDataModule.query_dovidka_1.SQL.add('ORDER BY POINTS.NAME');
...
procedure TfmDovidka_2_3.query_to_grid(query: TIBQuery;
...
procedure TfmDovidka_2_3.reportManualBuild(Page: TfrPage);
var
   i:integer;
begin
