...
var
  fmDovidka_7_3: TfmDovidka_7_3;

implementation

{$R *.DFM}

procedure TfmDovidka_7_3.FormCreate(Sender: TObject);
begin
...
procedure TfmDovidka_7_3.load_data;
var
   i:integer;
begin
...
procedure TfmDovidka_7_3.button_showClick(Sender: TObject);
begin
...
procedure TfmDovidka_7_3.reportGetValue(const ParName: String;
...
function TfmDovidka_7_3.execute_query: boolean;
var
   temp_string:string;
begin
...
procedure TfmDovidka_7_3.query_to_grid(query: TIBQuery;
...
procedure TfmDovidka_7_3.reportManualBuild(Page: TfrPage);
var
   i:integer;
begin
...
function TfmDovidka_7_3.get_items_comma_delimeter_from_checklistbox(
...
function TfmDovidka_7_3.get_stringlist_from_checklistbox(
...
function TfmDovidka_7_3.get_selected_from_checklistbox_determinated_comma(
...
function TfmDovidka_7_3.isCheckedCheckListBox(
...
procedure TfmDovidka_7_3.button_clearClick(Sender: TObject);
begin
   fmdatamodule.checklistbox_clear(self.CheckListBox_points);
end;

procedure TfmDovidka_7_3.button_invertClick(Sender: TObject);
begin
