...
type
  TfmDovidka_7 = class(TForm)
    ...
    procedure report_storehouseGetValue(const ParName: String;
...
var
  fmDovidka_7: TfmDovidka_7;

implementation

{$R *.DFM}

procedure TfmDovidka_7.FormCreate(Sender: TObject);
begin
...
procedure TfmDovidka_7.load_data;
var
   i:integer;
begin
...
procedure TfmDovidka_7.button_showClick(Sender: TObject);
var
   temp_string:string;
begin
   ...
   then begin
        ...
        then begin
             ...
             fmDataModule.query_dovidka_1.SQL.add('        COMMODITY.QUANTITY QUANTITY,');
             fmDataModule.query_dovidka_1.SQL.add('        ASSORTMENT.PRICE PRICE,');
             fmDataModule.query_dovidka_1.SQL.add('        COMMODITY.QUANTITY*ASSORTMENT.PRICE SUMA,');
             fmDataModule.query_dovidka_1.SQL.add('        ASSORTMENT.PRICE_BUYING PRICE_BUYING,');
             fmDataModule.query_dovidka_1.SQL.add('        COMMODITY.QUANTITY*ASSORTMENT.PRICE_BUYING SUMA_BUYING');
...
procedure TfmDovidka_7.reportGetValue(const ParName: String;
  var ParValue: Variant);
begin
   if ParName='POINTS'
...
procedure TfmDovidka_7.report_storehouseGetValue(const ParName: String;
  var ParValue: Variant);
begin
   if ParName='POINTS'
   then ParValue:=get_items_comma_delimeter_from_checklistbox(self.CheckListBox_points,true);
...
function TfmDovidka_7.get_items_comma_delimeter_from_checklistbox(
...
function TfmDovidka_7.get_stringlist_from_checklistbox(
...
function TfmDovidka_7.isCheckedCheckListBox(
...
procedure TfmDovidka_7.button_clearClick(Sender: TObject);
begin
   fmdatamodule.checklistbox_clear(self.CheckListBox_points);
end;

procedure TfmDovidka_7.button_invertClick(Sender: TObject);
begin
