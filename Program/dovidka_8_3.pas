...
var
  fmDovidka_8_3: TfmDovidka_8_3;

implementation

{$R *.DFM}

procedure TfmDovidka_8_3.FormCreate(Sender: TObject);
begin
...
procedure TfmDovidka_8_3.load_data;
var
   i:integer;
begin
...
procedure TfmDovidka_8_3.button_showClick(Sender: TObject);
begin
...
procedure TfmDovidka_8_3.reportGetValue(const ParName: String;
...
function TfmDovidka_8_3.execute_query: boolean;
var
   temp_string:string;
begin
...
procedure TfmDovidka_8_3.query_to_grid(query: TIBQuery;
...
procedure TfmDovidka_8_3.reportManualBuild(Page: TfrPage);
var
   i:integer;
begin
...
function TfmDovidka_8_3.get_items_comma_delimeter_from_checklistbox(
...
function TfmDovidka_8_3.get_stringlist_from_checklistbox(
...
procedure TfmDovidka_8_3.button_clearClick(Sender: TObject);
begin
   fmdatamodule.checklistbox_clear(self.CheckListBox_points);
end;

procedure TfmDovidka_8_3.button_invertClick(Sender: TObject);
begin
