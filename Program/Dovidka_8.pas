...
var
  fmDovidka_8: TfmDovidka_8;

implementation

{$R *.DFM}

procedure TfmDovidka_8.FormCreate(Sender: TObject);
begin
...
procedure TfmDovidka_8.load_data;
var
   i:integer;
begin
...
procedure TfmDovidka_8.button_showClick(Sender: TObject);
var
   temp_string:string;
begin
...
procedure TfmDovidka_8.reportGetValue(const ParName: String;
...
function TfmDovidka_8.get_items_comma_delimeter_from_checklistbox(
...
function TfmDovidka_8.get_stringlist_from_checklistbox(
...
function TfmDovidka_8.isCheckedCheckListBox(
...
procedure TfmDovidka_8.button_clearClick(Sender: TObject);
begin
   fmdatamodule.checklistbox_clear(self.CheckListBox_points);
end;

procedure TfmDovidka_8.button_invertClick(Sender: TObject);
begin
