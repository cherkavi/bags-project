...
var
  fmDovidka_9_2: TfmDovidka_9_2;

implementation

{$R *.DFM}

procedure TfmDovidka_9_2.FormCreate(Sender: TObject);
begin
...
procedure TfmDovidka_9_2.load_data;
var
   i:integer;
begin
...
procedure TfmDovidka_9_2.button_showClick(Sender: TObject);
begin
...
procedure TfmDovidka_9_2.reportGetValue(const ParName: String;
...
function TfmDovidka_9_2.execute_query: boolean;
var
   temp_string:string;
begin
...
procedure TfmDovidka_9_2.query_to_grid(query: TIBQuery;
...
procedure TfmDovidka_9_2.reportManualBuild(Page: TfrPage);
var
   i:integer;
begin
...
function TfmDovidka_9_2.get_items_comma_delimeter_from_checklistbox(
...
function TfmDovidka_9_2.get_stringlist_from_checklistbox(
...
procedure TfmDovidka_9_2.button_clearClick(Sender: TObject);
begin
   fmdatamodule.checklistbox_clear(self.CheckListBox_points);
end;

procedure TfmDovidka_9_2.button_invertClick(Sender: TObject);
begin
