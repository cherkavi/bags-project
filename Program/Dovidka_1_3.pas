...
var
  fmDovidka_1_3: TfmDovidka_1_3;

implementation

{$R *.DFM}

procedure TfmDovidka_1_3.FormCreate(Sender: TObject);
begin
...
procedure TfmDovidka_1_3.load_data;
var
   i:integer;
begin
...
procedure TfmDovidka_1_3.button_showClick(Sender: TObject);
begin
...
procedure TfmDovidka_1_3.reportGetValue(const ParName: String;
...
function TfmDovidka_1_3.execute_query: boolean;
var
   temp_string:string;
begin
...
procedure TfmDovidka_1_3.query_to_grid(query: TIBQuery;
...
procedure TfmDovidka_1_3.reportManualBuild(Page: TfrPage);
var
   i:integer;
begin
...
function TfmDovidka_1_3.get_stringlist_from_checklistbox(
...
function TfmDovidka_1_3.isCheckedCheckListBox(
...
function TfmDovidka_1_3.get_selected_from_checklistbox_determinated_comma(
...
procedure TfmDovidka_1_3.button_clearClick(Sender: TObject);
begin
   fmdatamodule.checklistbox_clear(self.CheckListBox_points);
end;

procedure TfmDovidka_1_3.button_invertClick(Sender: TObject);
begin
